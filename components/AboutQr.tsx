...
// AboutQr Component Definition Start Here
const AboutQr: React.FC = () => {
  return (
    <>
      <Helmet>
          <title>About the QR Code Generator | QuickLink</title>
          <meta name="description" content="A versatile tool for creating a wide array of QR codes. Go beyond simple links and generate codes for Wi-Fi, vCards, events, and more." />
          <meta name="keywords" content="qr code generator, create qr code, custom qr code, wifi qr, vcard qr" />
      </Helmet>
...
// AboutQr Component Definition End Here
