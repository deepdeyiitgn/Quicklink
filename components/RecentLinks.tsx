                ...
                <table className="min-w-full text-sm">
                    <thead className="text-gray-400">
                        <tr>
                            ...
                            <th className="text-left font-semibold p-2">Created</th>
                            <th className="text-right font-semibold p-2">Expires In</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-white/10">
                        {recentUrls.map(url => (
                            <tr key={url.id} className="text-gray-300">
                                ...
                                <td className="p-2 text-left text-gray-500 whitespace-nowrap">
