...
const SUBSCRIPTION_PLANS: Record<PlanId, { price: number; days: number; label: string; description: string, credits: number }> = {
    'monthly': { price: 50, days: 30, label: 'Monthly', description: '+200 Link Credits', credits: 200 },
    'semi-annually': { price: 100, days: 180, label: '6 Months', description: '+500 Link Credits', credits: 500 },
    'yearly': { price: 500, days: 365, label: '1 Year', description: '+2500 Link Credits', credits: 2500 },
};
                ...
                handler: async function (response: RazorpaySuccessResponse) {
                    ...
                    try {
                         await api.fulfillPurchase({
                            userId: currentUser.id,
                            productId: `SUB_PLAN_${selectedPlan.toUpperCase()}`, // A virtual product ID
