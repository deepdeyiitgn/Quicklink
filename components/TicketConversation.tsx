                    ...
                    <button
                        onClick={async () => {
                            try {
                                ...
                                alert("Unable to refresh right now.");
                            }
                        }}
                        className="text-xs px-3 py-1 rounded-md bg-zinc-800 hover:bg-zinc-700 text-gray-300 border border-white/10 transition-all"
                    >
                        🔄
                    </button>
                </div>
