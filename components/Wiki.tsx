...
export default function WikiPage(): React.ReactElement {
  ...
  return (
    <>
      <Helmet>
        <title>Deep Dey - Wiki | QuickLink</title>
        <meta name="description" content="A wiki-style profile of Deep Dey, the creator of QuickLink. Learn about his background, academic journey, and the philosophy behind his projects." />
        <meta name="keywords" content="deep dey, quicklink creator, deep dey wiki, jee aspirant, indian student developer" />
      </Helmet>
